        ...
        <div class="footer-items w-full mt-12 flex lg:gap-80 gap-4 lg:flex-nowrap flex-wrap">
            ...
            <div class="lg:basis-1/2 basis-full h-full flex justify-center gap-20 lg:justify-start lg:gap-9">
                <div>
                    ...
                    <ul class="mt-3">
                        <li class="lg:text-left text-center"><a class="text-[--color9] font-bold text-[13px]" href="/signup">Sign
                            Up</a></li>
                        <li class="lg:text-left text-center"><a class="text-[--color9] font-bold text-[13px]" href="/login">Sign
                            In</a></li>
