            ...
            <header class="flex md:flex-row md:justify-between flex-col items-start md:items-center md:gap-0 gap-4">
                ...
                <div class="flex items-center sm:w-auto w-full gap-0 sm:gap-3">
                    <div class="hidden sm:flex flex-row-reverse gap-2">
                        <button class="sort1 rounded-lg w-[32px] hidden sm:flex justify-center items-center h-[32px] hover:bg-[--color3] bg-[--color2] active">
                        ...
                        <button class="sort2 rounded-lg w-[32px] hidden sm:flex justify-center items-center h-[32px] hover:bg-[--color3] bg-[--color2]">
                ...
                <a class="conversation inline-block hover:bg-[--color2] transition-all duration-300 bg-[--color8] rounded-[14px] py-4 px-7 w-full"
                   href="#">
                    ...
                    <div class="content w-[calc(100%-80px)] float-end h-full inline-flex flex-col  align-top">
                        ...
                        <p class="tracking-normal text-white pr-2.5 text-[14px] font-medium line-clamp-2 mt-4">Hello, We
                            have 3 environments: local development, test server and the prod. The local dev server
                            cannot send emails. The test can send emails but I want to set the email addresses manually
                            and not to the actual recipients.The prod should send</p>
