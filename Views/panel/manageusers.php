                          ...
                          <td >
                            <span class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                  <a class="dropdown-item" href="/panel/upuser/<?= $user['id'] ?>" >
                                    update
                                  </a>
                                  <a class="dropdown-item" href="/panel/deluser/<?= $user['id'] ?>">
                                    delete
                                  </a>               
                              </div>
                            </span>
