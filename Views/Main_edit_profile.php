        ...
        <div class="flex gap-10 sm:flex-nowrap flex-wrap">
            <aside class="2xl:basis-[15%] lg:basis-[20%] lg:block basis-full relative">
                <div class="sticky top-8">
                    <img alt="" class="w-[120px] h-[120px] rounded-[14px]" src="images/avatar2.png">
                    <ul class="list-none mt-8 w-full left_side_ul">
                        <li class="w-full mt-2">
                            <a class="group w-full py-2 px-3 rounded-[14px] transition-all duration-300 flex justify-start items-center hover:bg-[--color8] text-white hover:text-[--color5] tracking-wide"
                               href="./edit_profile_account.html">
            ...
            <div class="2xl:basis-[66.5%] lg:basis-[80%] basis-full">
                <h2 class="text-white font-bold text-[23px]">Update Your Profile</h2>
                <form action="" method="get">
                    <div class="input-box mt-6">
                        <label class="text-[--color6] font-bold block" for="user_full_name">Full Name</label>
                        <div class="input relative">
                            <input autofocus=""
                                   class="peer mt-1 rounded-lg px-3 bg-[--color8] flex items-center h-[42px] w-full placeholder-gray-500 outline-0 text-white"
                                   id="user_full_name" name="user_full_name" placeholder="mohamadreza alizade"
                                   required="" type="text">
                        </div>
                    </div>
                    <div class="input-box mt-6">
                        <label class="text-[--color6] font-bold block" for="user_website">Website</label>
                        <div class="input relative">
                            <input class="peer mt-1 rounded-lg px-3 bg-[--color8] flex items-center h-[42px] w-full placeholder-gray-500 outline-0 text-white"
                                   id="user_website" name="user_website" placeholder="https://soft98.ir" required=""
                                   type="text">
                        </div>
                    </div>
                    <div class="input-box mt-6">
                        <label class="text-[--color6] font-bold block" for="user_bio">Short Bio</label>
                        <div class="input relative">
                            <textarea
                                    class="peer mt-1 rounded-lg px-3 bg-[--color8] flex items-center w-full placeholder-gray-500 outline-0 text-white"
                                    id="user_bio" name="user_bio" placeholder="Hi a`im mohamadreza..." required=""
                                    rows="4" type="text"></textarea>
                        </div>
                    </div>
                    <div class="input-box mt-6">
                        <label class="text-[--color6] font-bold block" for="user_twitter">Twitter Username</label>
                        <div class="input relative">
                            <input autofocus=""
                                   class="peer mt-1 rounded-lg px-3 bg-[--color8] flex items-center h-[42px] w-full placeholder-gray-500 outline-0 text-white"
                                   id="user_twitter" name="user_twitter" placeholder="@mohamadreza" required=""
                                   type="text">
                        </div>
                    </div>
                    <button class="bg_gr h-[40px] w-[180px] mt-6 rounded-[14px] flex justify-center items-center font-bold tracking-wide transition-all duration-300 text-white text-[14px] relative"
                            type="submit">
                        Update Profile
                    </button>
                </form>
