                    ...
                    <div class="input-box mt-6">
                        ...
                        <div class="input relative">
                            <input autofocus=""
                                   ...
                                   id="user_name" name="user_name" placeholder="Username..." required="" type="text">
                        </div>
                    </div>
                    <div class="input-box mt-6">
                        ...
                        <div class="input relative">
                            <input class="peer mt-1 rounded-lg px-3 bg-[--color8] flex items-center h-[42px] w-full placeholder-gray-500 outline-0 text-white"
                                   id="user_email" name="user_email" placeholder="Email..." required="" type="text">
                        </div>
                    </div>
                    <div class="input-box mt-6">
                        ...
                        <div class="input relative">
                            <input class="peer mt-1 rounded-lg px-3 bg-[--color8] flex items-center h-[42px] w-full placeholder-gray-500 outline-0 text-white"
                                   id="user_password" name="user_password" placeholder="Password..." required="" type="password">
                        </div>
                    </div>
                    <button class="bg_gr h-[40px] w-[180px] mt-6 rounded-[14px] flex justify-center items-center font-bold tracking-wide transition-all duration-300 text-white text-[14px] relative" type="submit">
                        Update Account
                    </button>
                </form>
            </div>
